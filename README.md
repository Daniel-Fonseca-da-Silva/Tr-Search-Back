...
Java: The backend is developed in Java, leveraging its robustness and scalability.

Spring Framework: We use the Spring Framework to build the foundation of our backend, providing comprehensive web development resources.

MySQL and PostgreSQL: MySQL and PostgreSQL databases are used to efficiently store and manage data.

Flyway Migration: Flyway Migration is used to control and automate database migrations.
