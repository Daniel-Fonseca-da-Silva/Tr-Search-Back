...
public record AllDatasCorporateUserDto(String name, String cellphone, String email, String documentation, Premium premium, String telephone, LocalDateTime lastLogin, LocalDateTime createdAt, LocalDateTime updateAt) {
    public AllDatasCorporateUserDto(CorporateUser corporateUser) {
