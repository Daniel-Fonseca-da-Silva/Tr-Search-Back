...
public record AllDatasRegularUserDto(UUID id, String name, String cellphone, String email, String documentation, String password, LocalDate birthday, Gender gender, LocalDateTime lastLogin, LocalDateTime createdAt, LocalDateTime updateAt) {
